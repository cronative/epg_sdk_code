...
//  EPG
//
//  Created by Mohd Arsad on 19/01/23.
//
...
/// real-life card type
internal enum CreditCardType: String {
...
internal class CCValidator: NSObject {
    ...
    /// looking for prefix)
    internal let prefixes: [CreditCardPrefix]
    ...
    internal init(prefixes: [CreditCardPrefix], lengths: [Int]) {
...
internal extension CCValidator {
...
internal class CreditCardPrefix {
    
    /// Credit Card type prefix starting range
    internal let rangeStart: Int
    
    /// Credit Card type prefix ending range
    internal let rangeEnd: Int
    
    /// Credit Card type prefix length
    internal let prefixLength: Int
    ...
    internal init(rangeStart: Int, rangeEnd: Int, length: Int) {
